...
Tags like `v0.1.16` create a GitHub Release with the Windows `.exe` installer and macOS `.dmg` attached. The macOS build runs on GitHub's macOS runner because DMG packaging must run on macOS.
